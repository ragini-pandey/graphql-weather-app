...
async function WeatherPage({ params: { city, lat, long } }: Props) {
  ...
  let content = 'Couldn’t generate the summary right now. Showing raw data instead.';
  ...
  try {
    ...
    if (res.ok) {
      ...
      console.error('getWeatherSummary failed:', res.status, res.statusText, text);
    }
  } catch (e) {
    console.error('Parsing getWeatherSummary response failed:', e);
  }
